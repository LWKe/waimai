...
<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      <link
        rel="stylesheet"
        href="//at.alicdn.com/t/font_2127961_zfouf1q999.css"
      /><link
        rel="stylesheet"
        href="//at.alicdn.com/t/font_2127968_cjzk48jexs.css"
      />
      <div class="overview">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          ...
          >
            不满意
            <span class="count">{{ ratings.length - positiveSize }}</span></span
          >
        </div>
        <div class="switch on">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span
                  ...
                  :class="
                    rating.rateType === 0 ? 'icon-thumb-up' : 'icon-thumbdown'
                  "
                ></span
                ><span
                  class="item"
    ...
    .rating-item {
      ...
      .content {
        ...
        .recommend {
          ...
          .icon-thumb-up, .icon-thumbdown, .item {
            display: inline-block;
            margin: 0 8px 4px 0;
            font-size: 9px;
          }
